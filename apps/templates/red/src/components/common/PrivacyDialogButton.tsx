...
const PrivacyDialogButton = () => {
  return (
    <Dialog>
      ...
      <DialogContent className="h-[70vh] overflow-y-auto sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>개인정보처리방침</DialogTitle>
        </DialogHeader>
        <DialogDescription>
          회사명(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의
          ...
          <br />
          <br />
          2. 재화 또는 서비스 제공 : 재화․서비스 공급완료 및 요금결제․정산 완료
          시까지
          <br />
          ...
          - 위탁받는 자 (수탁자) : (주)아임웹
          <br />
          - 위탁하는 업무의 내용 : 쇼핑몰 호스팅 서비스의 시스템 제공, 모바일 앱
          서비스, 마케팅 서비스 및 부가, 제휴서비스 제공 및 알림톡, 친구톡,
          문자메시지 발송대행 서비스 등<br />
          <br />
          - 위탁받는 자 (수탁자) : OOO PG
          <br />
          ...
          1. 홈페이지 회원 가입 및 관리
          <br />
          필수항목 : &lt;예) 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호,
          성별, 이메일주소, 아이핀번호&gt;
          <br />
          선택항목 : &lt;예) 결혼 여부, 관심 분야&gt;
          <br />
